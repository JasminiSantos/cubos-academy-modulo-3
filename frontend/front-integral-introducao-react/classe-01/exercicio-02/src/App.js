    ...
    <div className="content-wrapper">
            <article className="card">
                ...
                <div className="card__text-wrapper">
                    <h1 className="card__heading">Mude a aparência geral adicionando esses toques maravilhosos aos móveis de sua casa</h1>
                    <p className="card__paragraph">Já esteve em uma sala e sentiu como se algo estivesse faltando? Talvez um pouco vazia e convidativa. Tenho algumas dicas simples para tornar qualquer ambiente completo.</p>
                    <div className="card__footer-wrapper">
                        <img src={avatar} alt="author" className="author__img"/>
                        ...
                        <div className="popup">
                            ...
                            <div className="popup__icons">
                                ...
                                <a href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox='0 0 20 17' className='twitter'>
